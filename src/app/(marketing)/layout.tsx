...
export const metadata: Metadata = {
  ...
  description:
    'Done-for-you launch positioning and copy pack for indie makers: £99 one-time, delivered in 48 hours.',
};
...
export default function MarketingLayout({
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 border-b border-white/5 bg-[oklch(0.10_0.008_270)]/80 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <Link
            href="/"
            className="flex items-center gap-2 text-base font-semibold text-white hover:text-indigo-300 transition-colors"
          >
            <LogoMark />
            <span>LaunchKit</span>
          </Link>
